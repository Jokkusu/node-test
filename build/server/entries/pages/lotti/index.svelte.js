import { c as create_ssr_component, h as compute_rest_props, i as get_current_component, a as subscribe, g as getContext, s as setContext, o as onDestroy, t as set_store_value, j as spread, k as escape_attribute_value, n as escape_object, b as add_attribute, z as createEventDispatcher, A as tick, v as validate_component, u as each$1, e as escape } from "../../../chunks/index-bdac9f6e.js";
import "@material/dialog";
import "@material/dom";
import { w as writable, C as Content } from "../../../chunks/Actions-ce359a75.js";
import { f as forwardEventsBuilder, c as classMap, e as exclude, p as prefixFilter, N as Notification } from "../../../chunks/Notification-5c4b8c21.js";
...
class UserSignupModel {
  constructor(document2, password, phoneNumber, email) {
...
const css = {
  code: ".user-login-title{margin-top:20px}.main-content.svelte-1mn1998.svelte-1mn1998{height:70vh;background-color:var(--yellow);padding:20px 40px}.top-bar.svelte-1mn1998 img.svelte-1mn1998{height:60px}.top-bar.svelte-1mn1998 button.svelte-1mn1998{height:40px}h1.svelte-1mn1998.svelte-1mn1998{color:black;margin-top:20px}form.svelte-1mn1998.svelte-1mn1998{margin-top:60px}.link-button.svelte-1mn1998.svelte-1mn1998{text-decoration:underline;color:var(--link-blue);margin-bottom:20px}.banners.svelte-1mn1998.svelte-1mn1998{height:150px;width:100%}",
  map: null
};
const DOCUMENT_MIN_LENGHT = 6;
const PASSWORD_MIN_LENGHT = 8;
const PHONE_NUMBER_MIN_LENGHT = 8;
const EMAIL_MIN_LENGHT = 8;
const Lotti = create_ssr_component(($$result, $$props, $$bindings, slots) => {
  Swiper$1.use([Autoplay, Pagination, Navigation]);
  let activeLoginDialog = false;
  let activeSignupDialog = false;
  let userSignupModel = new UserSignupModel(void 0, "", "", "");
  let validSignupForm = false;
  let signupMessage = "";
  let requestResponseMessage = "";
  let bannersArray = [];
  for (let index2 = 0; index2 < 6; index2++) {
    const element = new BannerModel(index2, "https://picsum.photos/900/150?random=" + index2 + 1, 4);
  ...
  do {
    ...
    {
      {
        validSignupForm = userSignupModel.document && userSignupModel.document.toString().length > DOCUMENT_MIN_LENGHT && userSignupModel.password.length > PASSWORD_MIN_LENGHT && userSignupModel.phoneNumber.length > PHONE_NUMBER_MIN_LENGHT && userSignupModel.email.length > EMAIL_MIN_LENGHT;
      }
    }
    $$rendered = `${$$result.head += `${$$result.title = `<title>Lotti</title>`, ""}`, ""}

<div class="${"main-content svelte-1mn1998"}"><div class="${"top-bar flex-row center space-between w100 svelte-1mn1998"}"><img src="${"/lotti-logo.png"}" alt="${"Lotti Logo"}" class="${"svelte-1mn1998"}">
		${`<button class="${"button bg-red svelte-1mn1998"}">Ingresar</button>`}</div></div>
<div class="${"banners svelte-1mn1998"}">${validate_component(Swiper, "Swiper").$$render($$result, {
      spaceBetween: 30,
      centeredSlides: true,
      ...
      default: () => `${each$1(bannersArray, (banner) => `${validate_component(Swiper_slide, "SwiperSlide").$$render($$result, {}, {}, {
        default: () => `<img${add_attribute("src", banner.ImageUrl, 0)} alt="${"bannerImg"}">
			`
      })}`)}`
    })}</div>
...
${validate_component(Dialog, "Dialog").$$render($$result, {
      ...
      open: activeLoginDialog
    }, {
      open: ($$value) => {
        activeLoginDialog = $$value;
        $$settled = false;
      }
    }, {
      default: () => `${validate_component(Content, "Content").$$render($$result, {}, {}, {
		...
		<div style="${"padding: 10px;"}">${validate_component(Login, "Login").$$render($$result, { class: "user-login-title" }, {}, {})}</div>
		<div class="${"center-text"}"><button class="${"link-button svelte-1mn1998"}">\xBFNo tienes una cuenta? Reg\xEDstrate
			</button></div>`
      })}`
    })}
...
${validate_component(Dialog, "Dialog").$$render($$result, {
      surface$style: "width: 400px; max-width: calc(100vw - 32px);",
      open: activeSignupDialog
    }, {
      open: ($$value) => {
        activeSignupDialog = $$value;
        $$settled = false;
      }
    }, {
      default: () => `${validate_component(Content, "Content").$$render($$result, {}, {}, {
        default: () => `<div class="${"flex-row space-between"}"><button class="${"material-icons"}">arrow_back</button>
			<button class="${"material-icons"}">close</button></div>
		<div style="${"padding: 10px;"}"><h1 class="${"svelte-1mn1998"}">Registro</h1>
			<div class="${"line-decorator bg-yellow"}"></div>
			<form class="${"flex-column center svelte-1mn1998"}"><div class="${"form-group"}"><p>C\xE9dula</p>
					<input class="${"underlined-input"}" type="${"number"}"${add_attribute("value", userSignupModel.document, 0)}></div>
				<div class="${"form-group"}"><p>Contrase\xF1a</p>
					<input id="${"passwordInput"}" class="${"underlined-input"}" type="${"password"}"${add_attribute("value", userSignupModel.password, 0)}></div>
				<div class="${"form-group"}"><p>Celular</p>
					<input id="${"phoneInput"}" class="${"underlined-input"}" type="${"string"}"${add_attribute("value", userSignupModel.phoneNumber, 0)}></div>
				<div class="${"form-group"}"><p>Correo</p>
					<input id="${"emailInput"}" class="${"underlined-input"}" type="${"email"}"${add_attribute("value", userSignupModel.email, 0)}></div>
				<button ${!validSignupForm ? "disabled" : ""} class="${"button bg-yellow"}" type="${"submit"}">Registrarse</button>
				<p>${escape(signupMessage)}</p></form></div>`
      })}`
    })}
